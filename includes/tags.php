    ...
    <div class="modal-dialog modal-xl modal-dialog-centered modal-dialog-scrollable">
        <div class="modal-content user-select-none">
            ...
            <div class="modal-body">
                <?php foreach ($tags as $tag): ?>
                    <button type="button" class="btn btn-outline-primary shadow m-1" data-bs-dismiss="modal" onclick="sendTagByName('<?= $tag['name'] ?>')">
                        <?= $tag['name'] ?> <span class="badge bg-info"><?= $tag['count'] ?></span>
                    </button>
                <?php endforeach; ?>
            </div>
